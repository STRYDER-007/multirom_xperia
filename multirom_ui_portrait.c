...
#define LISTVIEW_MARGIN (15*DPI_MUL)

#define REFRESHBTN_W (370*DPI_MUL)
#define REFRESHBTN_H (30*DPI_MUL)

#define MISCBTN_W (500*DPI_MUL)
#define MISCBTN_H (70*DPI_MUL)

#define CLRBTN_W (20*DPI_MUL)
#define CLRBTN_B (5*DPI_MUL)
#define CLRBTN_TOTAL (CLRBTN_W+CLRBTN_B)
#define CLRBTN_Y (1000*DPI_MUL)
#define CLRBTN_MARGIN (5*DPI_MUL)
